...
@section('body')
    <div class="min-h-screen bg-[#eef4fb]">
        <div class="p-0 lg:p-5">
            <div class="glass-panel min-h-screen rounded-none border-0 lg:min-h-0 lg:rounded-[2.2rem] lg:border">
                <div class="border-b border-slate-200/80 px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-6 flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-3">
                            <button type="button" class="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-lg text-slate-500 shadow-sm"><i class="fa-solid fa-magnifying-glass"></i></button>
                            <button type="button" class="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-lg text-slate-500 shadow-sm">
