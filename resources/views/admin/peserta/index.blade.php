    ...
    <div class="space-y-6">
        ...
        <div class="panel p-6">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <form action="{{ route('admin.peserta.index') }}" method="GET" class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <input type="text" name="search" value="{{ $filters['search'] }}" placeholder="Cari nama, email, atau telepon..." class="field sm:w-64">
